    ...
    <main className="container mx-auto p-4 max-w-6xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <Card>
          ...
          <CardContent>
            <p className="text-2xl font-bold text-foreground">{merchantInsights.length}</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="pb-2">
          ...
          <CardContent>
            <p className="text-2xl font-bold text-foreground">${totalMerchantSpend.toFixed(2)}</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="pb-2">
          ...
          <CardContent>
            <p className="text-2xl font-bold text-foreground">${totalRecurringMonthly.toFixed(2)}</p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="mb-6">
        <h2 className="text-lg font-semibold mb-3 text-foreground">Detected Recurring Charges</h2>
      ...
      {/* Merchant Table */}
      <div className="mb-6">
        <h2 className="text-lg font-semibold mb-3 text-foreground">All Merchants</h2>
        {merchantInsights.length === 0 ? (
          <Card>
            <CardContent className="py-8 text-center text-muted-foreground">
